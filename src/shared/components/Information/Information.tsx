    ...
    <div className="Information">
      <div className="pure-g section-padding">
        ...
        <div className="pure-u-1 pure-u-sm-1-2">
          ...
          <p className="content">
            Oswaldo Díaz Díaz, fue un autor prolífico del siglo XX, además de profesor, historiador y abogado. Escribió
            cuentos, teatro, radioteatro y textos de no ficción, por lo que dejó un legado muy importante para la
            construcción de la historia de la literatura infantil colombiana.
          </p>
          <p className="content">
