...
export const caricaturaContent = (
  <div>
    <p className="content justified">
      “Los que nos dedicamos a la enseñanza bien sabemos que hay tres imperativos a los que estamos sometidos: el apodo,
      la caricatura y el ser remedados. En materia de caricaturas tengo una buena colección y con firmas ya ilustres”.
      Oswaldo Díaz Díaz
    </p>
    <p className="content justified">
    ...
    <p className="content justified">
      ...
      colegio Libertad y Orden en 1948, el cual funcionó hasta 1949.
    </p>
    <p className="content justified">
      También fue docente en colegios como: Liceo Nacional Femenino, Instituto Pedagógico Nacional, Colegio de la
